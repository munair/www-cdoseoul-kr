...
Copy the contents of the 1st script of this README.md, dump a copy into machine-setup.bash on your development Mac
and run the script using the new EC2 instance name and the GitHub repository as the first and second script parameters.
...
heroku git:remote -a staging-cdoseoul-kr -r staging-heroku
git push staging-heroku staging:master
curl http://staging-cdoseoul-kr.herokuapp.com | more
[ $3 == "noprompting" ] || while true; do
...
heroku git:remote -a www-cdoseoul-kr -r production-heroku
git push production-heroku master:master
curl http://www-cdoseoul-kr.herokuapp.com | more
git checkout development
